# Copia la lista en un programa python y realiza un programa que muestre las siguientes informaciones:
...
# Pide un año por teclado y muestra todas las películas anteriores a ese año.
...
print("=========================")
print("Nombre de la pelicula y argumento")
print("=========================")

for pelicula in peliculas:
	print (f"El titulo es: {pelicula["title"]} \n El argumento es : {pelicula["storyline"]}")
	print ("---------------------------------------")


print("=========================")
print("Nombre de la pelicula y actores")
print("=========================")

for pelicula in peliculas:
	print (f"El titulo es: {pelicula["title"]}")
	for actores in pelicula["actors"]:
		print ("El actor: ", actores, "pertenece a la pelicula")
	print ("---------------------------------------")
 
print("=========================")
print("Pelicula por genero")
print("=========================")

genero=input("Dime el genero de pelicula que buscas: ")

for pelicula in peliculas:
    
	if genero in pelicula["genres"]:
		print(f"Las peliculas cuyo genero es {genero} son: {pelicula["title"]}")

anyo=input("Dime el año en formato YYYY-MM-DD: ")

for pelicula in peliculas:
    
	if anyo < pelicula["releaseDate"]:
		print(f"Las peliculas cuyo año es menor que {anyo} son: {pelicula["title"]}")